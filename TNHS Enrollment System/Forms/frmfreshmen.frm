...
Begin VB.Form frmfreshmen 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin ShockwaveFlashObjectsCtl.ShockwaveFlash swf1 
         ...
         _cy             =   4260
         FlashVars       =   ""
         Movie           =   "C:\Documents and Settings\Vargas\My Documents\TNHS Enrollment System\flash\freshmen.swf"
         Src             =   "C:\Documents and Settings\Vargas\My Documents\TNHS Enrollment System\flash\freshmen.swf"
         WMode           =   "Window"
         Play            =   0   'False
         Loop            =   -1  'True
         Quality         =   "High"
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CheckBox Check1 
         BackColor       =   &H00400000&
         Caption         =   "Elementary School Card"
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   9.75
            Charset         =   0
      ...
      Begin VB.ComboBox Combo1 
         ...
         EndProperty
         Height          =   360
         ItemData        =   "frmfreshmen.frx":45EE
         Left            =   1560
         List            =   "frmfreshmen.frx":45F8
         TabIndex        =   5
         Text            =   "Select Gender.."
         Top             =   3000
         Width           =   2175
   ...
   Begin VB.Label Label14 
      BackStyle       =   0  'Transparent
      Caption         =   "TNHS Enrollment System- Enrollment Form (Freshmen)"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.Image Image2 
      Height          =   2040
      Left            =   -5280
      Picture         =   "frmfreshmen.frx":B745
      Stretch         =   -1  'True
      Top             =   480
      Width           =   19440
   End
End
Attribute VB_Name = "frmfreshmen"
...
If Len(txt1.Text) = 0 Or Len(txt2.Text) = 0 Or Len(Text1.Text) = 0 Or Len(txt3.Text) = 0 Or Len(txt4.Text) = 0 Or Len(txt5.Text) = 0 Or Len(txt6.Text) = 0 Or Len(txt7.Text) = 0 Or Len(txt8.Text) = 0 Or Len(txt9.Text) = 0 Or Len(txt10.Text) = 0 Or Len(txt11.Text) = 0 Or Combo1.Text = "Select Gender.." Or Len(Text4.Text) = 0 Then
...
Set RS = New ADODB.Recordset
    ...
    .Fields("studrank") = (Int(Text1.Text) * 5) + ((Int(Text2.Text) + Int(Text3.Text) + Int(Text6.Text) + Int(Text5.Text)) / 4)
...
End If
    RS.Close
     End With
     usrlog ("Edited Freshmen Student with Student Number:" & txt1.Text)
...
End If
Else
If Len(txt1.Text) = 0 Or Len(txt2.Text) = 0 Or Len(Text1.Text) = 0 Or Check1.Value = 0 Or Len(txt3.Text) = 0 Or Len(txt4.Text) = 0 Or Len(txt5.Text) = 0 Or Len(txt6.Text) = 0 Or Len(txt7.Text) = 0 Or Len(txt8.Text) = 0 Or Len(txt9.Text) = 0 Or Len(txt10.Text) = 0 Or Len(txt11.Text) = 0 Or Combo1.Text = "Select Gender.." Or Len(Text4.Text) = 0 Or Check3.Value = 0 Then
MsgBox "Input data from Required fields"
Else
Set RS = New ADODB.Recordset
    If RS.State = 1 Then RS.Close
    RS.ActiveConnection = Con
    ...
    RS.Update
    RS.Close
    usrlog ("Added Freshmen Student with Student Number:" & txt1.Text)
 SavePicture Image4, App.Path & "/students/" & txt1.Text & ".jpg"
...
Call dbConnection
swf1.Movie = App.Path & "\flash\freshmen.swf"
swf1.Play
Image4.Picture = frmmain.imagelist1.ListImages(51).Picture
Me.Width = 225
